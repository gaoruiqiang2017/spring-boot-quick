...
public class HttpUtil {
    ...
    public static HttpResult httpGet(String url, String encoding, String cookies) {
        return httpGet(url, encoding, cookies, 100, 500);
    }

    public static HttpResult httpGet(String url, String encoding, String cookies, int connectTimeout, int readTimeout) {
        int trytimes = 3;
        while (trytimes > 0) {
